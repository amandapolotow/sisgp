...
public class GraficoCategoriaContasPagarViewHelper implements InterfaceViewHelper{

	@Override
	public InterfaceEntidade getEntidade(HttpServletRequest request) {
		String operacao = request.getParameter("operacao");
		GraficoCategoriaContasPagar graf = null;
		...
		if(operacao != null && operacao.equals("consultar")) {
			...
			Date dt = null;
			graf = new GraficoCategoriaContasPagar();
	...
	public void setView(Resultado resultado, HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher d = request.getRequestDispatcher("GraficoCategoriaContasPagar.jsp");
		String operacao = request.getParameter("operacao");
		...
		if(resultado != null && operacao.equals("consultar")){
			...
			request.getSession().setAttribute("grafico_categoria_contas_pagar_resultado", resultado);
