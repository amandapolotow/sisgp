...
public class ConsultarCatCtReceberViewHelper implements InterfaceViewHelper{
	...
	public void setView(Resultado resultado, ServletConfig config) {
		// TODO Auto-generated method stub
		config.getServletContext().setAttribute("resultado_categoria_contas_receber", resultado);
	}
