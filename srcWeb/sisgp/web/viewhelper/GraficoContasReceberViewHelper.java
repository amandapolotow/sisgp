...
public class GraficoContasReceberViewHelper implements InterfaceViewHelper{

	@Override
	public InterfaceEntidade getEntidade(HttpServletRequest request) {
		String operacao = request.getParameter("operacao");
		GraficoContasReceber graf = null;
	...
	public void setView(Resultado resultado, HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher d = request.getRequestDispatcher("GraficoContasReceber.jsp");
		String operacao = request.getParameter("operacao");
		...
		if(resultado != null && operacao.equals("consultar")){
			...
			request.getSession().setAttribute("grafico_contas_receber_resultado", resultado);
