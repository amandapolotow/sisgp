...
public class GsonCategoriaContasReceberViewHelper implements InterfaceViewHelper {
	...
	public void setView(Resultado resultado, HttpServletRequest request, HttpServletResponse response)
		...
		resultado = (Resultado) session.getAttribute("grafico_categoria_contas_receber_resultado");
