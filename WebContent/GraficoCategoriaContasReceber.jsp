...
<div class=content>
	<h3>Grafico de Contas a Receber por Categoria</h3>
<br>
<div class="container">
<script type="text/javascript">
	$(document).ready(function(){
		...
		$.ajax({
			url: "GsonCategoriaContasReceber",
			dataType: "JSON",
				...
				google.charts.setOnLoadCallback(function(){
				 ...
				 function drawChart() {
				      ...
				      $.each(result, function(i, obj){
				    	  dataArray.push([ obj.categoria, obj.vlTotal ]);
				    	  //alert(obj.mes);
				      ...
				      var piechart_options = {
				      		title: "Distribuição Contas a Receber",
				      	   // width: 800,
				      	    height: 500
				      }
				     ...
				     /* var columnchart_options = {
					      		title: "Custos Mensais de Projetos",
					      	   // width: 800,
					      	    height: 500
					      }*/
